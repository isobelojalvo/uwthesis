...
The DA algorithm is based upon the %fix new and doesn't make sense
...
of temperature, or annealing. %fix
...
such as the $k_{T}$ \ref{} %ref
and Cambridge/Aachen \ref{} %ref
...
of final jets. 
Algorithms such as SIScone \ref{} %ref
