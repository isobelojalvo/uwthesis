...
The final relevant term in the Standard Model Lagrangian that gives
the $W^{\pm}$ and $Z$ bosons their mass is,
\begin{equation} 
\left| \left( i\partial_{\mu}+gT_{a}W_{\mu}^{1}+g'B_{\mu}\frac{Y}{2}\right)\phi \right|^{2} - V(\phi)
\end{equation}
