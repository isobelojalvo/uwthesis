%%%%%%%WRITE ABOUT RHO CORRECTIONS
%%%%%%%WRITE ABOUT SVFIT
\chapter{Search for an MSSM Higgs Boson}
...
%and 8 \TeV at the LHC  
%The data were recorded by the Compact Muon Solenoid experiment (CMS)~\cite{CMS-JINST} 
%in 2011 and 2012 
...
%,  \Pe\Pgm$, $\Pgm\Pgm$ and $\Pgt_{h}\Pgt_{h}$, where $\Pgt_{h}$ denotes a 
...
%In particular, LEP studied
%while ATLAS focused on similar final state
%D0 used
...
%To reduce the contamination of $\cPZ\to\Pe\Pe, \Pgm\Pgm$ background, events with two electrons 
%or muons of $\pt >15~\GeV$, opposite charge and with a $I_{\rm rel}<0.15$ are rejected.
%
%The $\Pe\Pgm$ and $\Pgm\Pgm$ are reported in more detail elsewhere. 

Events in the $\Pe\Pgt_h$ final state reject $\cPZ\to\Pe\Pe$ background by rejecting events with
...
%%%%%%%%%%%%%%%Adding Figures Reference these
\begin{figure}[htbp]
  \begin{center}
    \includegraphics[width=0.45\textwidth]{MSSM/PLOTS/pt_1_eTau_2011.pdf}
    \includegraphics[width=0.45\textwidth]{MSSM/PLOTS/pt_1_eTau_2012.pdf}
    \includegraphics[width=0.45\textwidth]{MSSM/PLOTS/eta_1_eTau_2011.pdf}
    \includegraphics[width=0.45\textwidth]{MSSM/PLOTS/eta_1_eTau_2012.pdf}
    \caption{
...
\begin{figure}[htbp]
  \begin{center}
    \includegraphics[width=0.45\textwidth]{MSSM/PLOTS/pt_1_muTau_2011.pdf}
    \includegraphics[width=0.45\textwidth]{MSSM/PLOTS/pt_1_muTau_2012.pdf}
    \includegraphics[width=0.45\textwidth]{MSSM/PLOTS/eta_1_muTau_2011.pdf}
    \includegraphics[width=0.45\textwidth]{MSSM/PLOTS/eta_1_muTau_2012.pdf}
    \caption{
...
\begin{figure}[htbp]
  \begin{center}
    \includegraphics[width=0.45\textwidth]{MSSM/PLOTS/pt_2_muTau_2011.pdf}
    \includegraphics[width=0.45\textwidth]{MSSM/PLOTS/pt_2_muTau_2012.pdf}
    \includegraphics[width=0.45\textwidth]{MSSM/PLOTS/eta_2_muTau_2011.pdf}
    \includegraphics[width=0.45\textwidth]{MSSM/PLOTS/eta_2_muTau_2012.pdf}
    \caption{
...
\begin{figure}[htbp]
  \begin{center}
    \includegraphics[width=0.45\textwidth]{MSSM/PLOTS/pt_2_eTau_2011.pdf}
    \includegraphics[width=0.45\textwidth]{MSSM/PLOTS/pt_2_eTau_2012.pdf}
    \includegraphics[width=0.45\textwidth]{MSSM/PLOTS/eta_2_eTau_2011.pdf}
    \includegraphics[width=0.45\textwidth]{MSSM/PLOTS/eta_2_eTau_2012.pdf}
    \caption{
      Distribution of the $\tau_{h}$ transverse momentum and psuedorapidity.}
...
\begin{figure}[htbp]
  \begin{center}
    \includegraphics[width=0.45\textwidth]{MSSM/PLOTS/met_muTau_2011.pdf}
    \includegraphics[width=0.45\textwidth]{MSSM/PLOTS/met_muTau_2012.pdf}
    \includegraphics[width=0.45\textwidth]{MSSM/PLOTS/met_eTau_2011.pdf}
    \includegraphics[width=0.45\textwidth]{MSSM/PLOTS/met_eTau_2012.pdf}
    \caption{
...
\begin{figure}[htbp]
  \begin{center}
    \includegraphics[width=0.45\textwidth]{MSSM/PLOTS/mt_1_muTau_2011.pdf}
    \includegraphics[width=0.45\textwidth]{MSSM/PLOTS/mt_1_muTau_2012.pdf}
    \includegraphics[width=0.45\textwidth]{MSSM/PLOTS/mt_1_eTau_2011.pdf}
    \includegraphics[width=0.45\textwidth]{MSSM/PLOTS/mt_1_eTau_2012.pdf}
    \caption{
...
\begin{figure}[htbp]
  \begin{center}
    \includegraphics[width=0.45\textwidth]{MSSM/PLOTS/mvis_muTau_2011.pdf}
    \includegraphics[width=0.45\textwidth]{MSSM/PLOTS/mvis_muTau_2012.pdf}
    \includegraphics[width=0.45\textwidth]{MSSM/PLOTS/mvis_eTau_2011.pdf}
    \includegraphics[width=0.45\textwidth]{MSSM/PLOTS/mvis_eTau_2012.pdf}
    \caption{
...
\begin{figure}[htbp]
  \begin{center}
    \includegraphics[width=0.45\textwidth]{MSSM/PLOTS/m_sv_muTau_2011.pdf}
    \includegraphics[width=0.45\textwidth]{MSSM/PLOTS/m_sv_muTau_2012.pdf}
    \includegraphics[width=0.45\textwidth]{MSSM/PLOTS/m_sv_eTau_2011.pdf}
    \includegraphics[width=0.45\textwidth]{MSSM/PLOTS/m_sv_eTau_2012.pdf}
    \caption{
...
\begin{figure}[htbp]
  \begin{center}
    \includegraphics[width=0.45\textwidth]{MSSM/PLOTS/njets_muTau_2011.pdf}
    \includegraphics[width=0.45\textwidth]{MSSM/PLOTS/njets_muTau_2012.pdf}
    \includegraphics[width=0.45\textwidth]{MSSM/PLOTS/njets_eTau_2011.pdf}
    \includegraphics[width=0.45\textwidth]{MSSM/PLOTS/njets_eTau_2012.pdf}
    \caption{
...
\begin{figure}[htbp]
  \begin{center}
    \includegraphics[width=0.45\textwidth]{MSSM/PLOTS/hjetpt_muTau_2011.pdf}
    \includegraphics[width=0.45\textwidth]{MSSM/PLOTS/hjetpt_muTau_2012.pdf}
    \includegraphics[width=0.45\textwidth]{MSSM/PLOTS/hjeteta_muTau_2011.pdf}
    \includegraphics[width=0.45\textwidth]{MSSM/PLOTS/hjeteta_muTau_2012.pdf}
    \caption{
...
\begin{figure}[htbp]
  \begin{center}
    \includegraphics[width=0.45\textwidth]{MSSM/PLOTS/hjetpt_eTau_2011.pdf}
    \includegraphics[width=0.45\textwidth]{MSSM/PLOTS/hjetpt_eTau_2012.pdf}
    \includegraphics[width=0.45\textwidth]{MSSM/PLOTS/hjeteta_eTau_2011.pdf}
    \includegraphics[width=0.45\textwidth]{MSSM/PLOTS/hjeteta_eTau_2012.pdf}
    \caption{
      Distribution of the leading jet transverse momentum and psuedorapidity.
    }
...
\begin{figure}[htbp]
  \begin{center}
    \includegraphics[width=0.45\textwidth]{MSSM/PLOTS/nbtags_muTau_2011_log.pdf}
    \includegraphics[width=0.45\textwidth]{MSSM/PLOTS/nbtags_muTau_2012_log.pdf}
    \includegraphics[width=0.45\textwidth]{MSSM/PLOTS/nbtags_eTau_2011_log.pdf}
    \includegraphics[width=0.45\textwidth]{MSSM/PLOTS/nbtags_eTau_2012_log.pdf}
    \caption{
...
are shown in Tables~\ref{table:events_mutau} and \ref{table:events_etau} %~\ref{table:events_mumu} 
...
Events from $\PW$+jets in which there is a jet misidentified as 
...
Various imperfectly known or simulated effects can alter the shape and 
