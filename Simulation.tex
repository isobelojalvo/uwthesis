...
The purpose of event simulation is to 
%give physicists an idea of what events one can expect to find and at what rates
%help plan new detectors
%devise analysis strategies
%as a framework in which to interpret the significance of observed phenomena
%Do not trust a single generator
...
%%Lund String Model
The Lund String is based on the idea that %fix from lattice QCD simulations
that at large distance the potential energy of color sources increases
linearly with their separation: Considering the production of a quark-anti-quark pair,
