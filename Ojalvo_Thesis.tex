...
\newcommand{\lumi}{\ensuremath{\,\mathrm{(lum.)}}\xspace}
\newcommand{\theo}{\ensuremath{\,\mathrm{(theo.)}}\xspace}
\providecommand{\vecEtm}{\ensuremath{\vec{E}_\mathrm{T}^{\mathrm{miss}}}\xspace}
\providecommand{\vecPtmu}{\ensuremath{\vec{P}_\mathrm{T}^{\mu}}\xspace}
