...
$\eta$ values. 
The TPG electronics are integrated with calorimeter readout and trigger primitives
are transported to then transported to the Regional Calorimeter Trigger (RCT) using
