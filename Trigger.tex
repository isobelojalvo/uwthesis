...
in jets. 
The L1 $e/\gamma$ algorithm is applied to trigger towers that have an energy%%%%e/g is ecal only
...
is isolated. As can be seen in figure %%%ADD FIGURE
...
The RCT also sums ECAL and HCAL energies in to regions, these are passed
...
Good performance of the RCT is essential therefore the performance of the RCT%%%changeeeee
